    ...
    <div>
        ...
        <v-dialog v-model="loading" width="350" persistent>
            <v-card width="100%" rounded="lg">
                <div style="display: flex;justify-content: center;align-items: center;flex-direction: column;" class="pa-10">
                    <Icon name="mdi-light:check-circle" size="80" color="#59B259"/>
                    <span style="font-size: 16pt;color: #59B259;">ສຳເລັດແລ້ວ</span>
                </div>
                <v-btn color="#59B259" style="border-radius: 0%;height: 50px;font-size: 12pt;font-weight: bold;" @click="loading=false">ຕົກລົງ</v-btn>
            </v-card>
        </v-dialog>
        <v-dialog v-model="erroring" width="350" persistent>
            <v-card width="100%" rounded="lg">
                ...
                <v-btn color="#860002" style="border-radius: 0%;height: 50px;font-size: 12pt;font-weight: bold;" @click="erroring=false">ຕົກລົງ</v-btn>
            </v-card>
        </v-dialog>
        <v-dialog v-model="warning" width="350" persistent>
            <v-card width="100%" rounded="lg">
                ...
                <v-btn color="#EF7003" style="border-radius: 0%;height: 50px;font-size: 12pt;font-weight: bold;" @click="warning=false">ຕົກລົງ</v-btn>
            </v-card>
        </v-dialog>
        <v-dialog v-model="question" width="350" persistent>
            <v-card width="100%" rounded="lg">
                ...
                <div style="display: flex;justify-content: space-between;flex-direction: row;width: 100%;">
                    <v-btn color="#860002" elevation="0" style="border-radius: 0%;height: 50px;font-size: 12pt;font-weight: bold;width: 50%;" @click="question=false">ຍົກເລີກ</v-btn>
                    <v-btn color="#035F9F" elevation="0" style="border-radius: 0%;height: 50px;font-size: 12pt;font-weight: bold;width: 50%;" @click="question=false">ຕົກລົງ</v-btn>
