                ...
                <tbody>
                    <tr v-for="(item, index) in documentList" :key="index"
                        ...
                        <td>
                            ...
                            <v-btn @click="onAskBeforeApprove(item?.id)" density="comfortable" color="#243A7A">
                                ອະນຸມັດ
                            </v-btn>
                            <v-btn class="ml-2" @click="onAskBeforeReject(item?.id)" density="comfortable" color="red">
                                ປະຕິເສດ
                            </v-btn>
                        </td>
                    </tr>
